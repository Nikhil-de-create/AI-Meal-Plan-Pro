                        ...
                        <div>
                          ...
                          <div className="space-y-1 max-h-32 overflow-y-auto">
                            {itemsInPantry.map((item: string, index: number) => {
                              const ingredientName = extractIngredientName(item);
                              const icon = getIngredientIcon(ingredientName);
                              return (
                                <div key={`pantry-${index}`} className="flex items-center space-x-3 p-2 rounded bg-green-50">
                        ...
                        <div>
                          ...
                          <div className="space-y-1 max-h-32 overflow-y-auto">
                            {itemsToOrder.map((item: string, index: number) => {
                              ...
                              const icon = getIngredientIcon(ingredientName);
                              return (
                                <div key={`order-${index}`} className="flex items-center space-x-3 p-2 rounded hover:bg-neutral-50 transition-colors">
